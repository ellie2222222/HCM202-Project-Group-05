...
import { Megaphone, Users, Link, CheckCircle, Smartphone, Monitor, MessageCircle } from 'lucide-react';

export default function PhuongThucSection() {
  return (
    <section className="py-20 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 bg-gradient-to-r from-red-50/30 via-transparent to-yellow-50/30"></div>
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-red-100/20 to-transparent rounded-full -translate-y-48 translate-x-48"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
        ...
        >
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-[#D32F2F] mb-4">Phương thức xây dựng</h3>
            <div className="w-24 h-1 bg-gradient-to-r from-[#D32F2F] to-[#FFD700] mx-auto rounded-full"></div>
            <p className="text-lg text-gray-600 mt-6 max-w-3xl mx-auto">
              Những phương pháp cơ bản để xây dựng và củng cố khối đại đoàn kết toàn dân tộc
            </p>
          </div>
          ...
          <div className="space-y-12">
            {[
              { 
                ...
                detail: 'Người căn dặn: "cần phải chịu khó tìm đủ cách giải thích cho họ hiểu rằng: những việc đó là vì ích lợi của họ mà phải làm." Mọi phương pháp tiếp cận phải xuất phát từ tâm tư, nguyện vọng, phong tục, tập quán và đặc thù từng địa phương.'
              },
              { 
                number: 'Hai là',
                icon: Users, 
                ...
                detail: 'Các tổ chức này có nhiệm vụ tập hợp, giáo dục, động viên nhân dân tham gia cách mạng, bảo vệ quyền lợi của mình và ngày càng trở thành hạt nhân vững chắc của khối đại đoàn kết.'
              },
              { 
                number: 'Ba là',
                icon: Link, 
                title: 'Tập hợp các đoàn thể, tổ chức quần chúng trong Mặt trận dân tộc thống nhất', 
                  ...
                  <div className="flex items-start space-x-6 relative z-10">
                    <div className="flex-shrink-0">
                      <div className="relative">
                        <div className="bg-gradient-to-br from-[#D32F2F] to-[#FF6B35] text-white rounded-2xl w-16 h-16 flex items-center justify-center font-bold text-xl shadow-lg">
                          {index + 1}
                        </div>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-700 mb-6 leading-relaxed text-lg font-medium">{item.desc}</p>
                      <div className="bg-gradient-to-r from-gray-50 to-blue-50 rounded-xl p-6 border-l-4 border-[#D32F2F]">
                        <p className="text-gray-600 leading-relaxed text-base">{item.detail}</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        >
          <div className="text-center mb-16">
            <h3 className="text-4xl font-bold text-[#D32F2F] mb-4">Phương thức hiện đại</h3>
            <div className="w-24 h-1 bg-gradient-to-r from-[#D32F2F] to-[#FFD700] mx-auto rounded-full"></div>
            <p className="text-lg text-gray-600 mt-6 max-w-3xl mx-auto">
              Ứng dụng công nghệ hiện đại để tăng cường hiệu quả xây dựng khối đại đoàn kết
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { 
                ...
                features: ['Facebook, Zalo, TikTok', 'Truyền thông đa phương tiện', 'Tương tác trực tiếp'],
              ...
              { 
                ...
                features: ['Zoom, Teams, Google Meet', 'Ghi hình và lưu trữ', 'Bình đẳng tham gia'],
              ...
              { 
                ...
                features: ['Diễn đàn trực tuyến', 'Bình luận công khai', 'Phản hồi tức thời'],
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-xl transition-all duration-300 border border-gray-100 hover:shadow-2xl hover:border-[#D32F2F]/30 text-center space-y-6 relative overflow-hidden">
                  {/* Background decoration */}
                  <div className={`absolute top-0 right-0 w-24 h-24 bg-gradient-to-bl ${item.color} opacity-10 rounded-full -translate-y-12 translate-x-12`}></div>
                  ...
                  <div className="relative z-10">
                    ...
                    <p className="text-gray-700 mb-6 text-lg font-medium">{item.desc}</p>
