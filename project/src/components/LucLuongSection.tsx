...
import { Factory, Wheat, Brain, Cross, Briefcase, Globe, Users } from 'lucide-react';
...
export default function LucLuongSection() {
  return (
    <section className="py-20 bg-gray-50">
        ...
        <div className="mb-16">
          <h3 className="text-2xl font-bold text-center text-[#D32F2F] mb-8">Bản đồ tương tác các lực lượng theo vùng miền</h3>
        ...
        >
          <h3 className="text-2xl font-bold text-center text-[#D32F2F] mb-8">Các lực lượng chính</h3>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              { 
                ...
                detail: 'Công nhân đoàn kết chặt chẽ với nông dân và trí thức để làm nòng cốt cho khối đại đoàn kết.'
              },
              { 
                icon: Wheat, 
              ...
              { 
                ...
                detail: 'Hồ Chí Minh đánh giá cao vai trò trí thức trong việc nâng cao dân trí, phát triển đất nước.'
              },
              { 
                icon: Users, 
                title: 'Các tầng lớp lao động khác', 
                desc: 'Bao gồm tiểu thương, tiểu chủ, doanh nhân yêu nước...',
                detail: 'Họ có quyền lợi gắn bó với dân tộc, nên đều được tập hợp trong khối đoàn kết.'
              },
              { 
                icon: Cross, 
                title: 'Các dân tộc anh em', 
                desc: 'Hồ Chí Minh khẳng định: "Nước ta có nhiều dân tộc, mà dân tộc nào cũng là con cháu Lạc Hồng."',
                detail: 'Đại đoàn kết phải gắn liền với đoàn kết dân tộc Kinh – Thượng, không phân biệt lớn nhỏ.'
              },
              { 
                icon: Globe, 
                title: 'Người Việt Nam ở nước ngoài', 
                desc: 'Dù ở xa Tổ quốc nhưng luôn là một bộ phận máu thịt của dân tộc.',
                detail: 'HCM nhiều lần kêu gọi kiều bào "đoàn kết, giúp đỡ đồng bào trong nước".'
              }
            ].map((item, index) => (
              <motion.div
                key={index}
              ...
              >
                ...
                <h4 className="text-xl font-bold text-[#D32F2F] text-center">{item.title}</h4>
                <p className="text-gray-700 text-center text-sm leading-relaxed">{item.desc}</p>
                <p className="text-gray-600 text-center text-xs italic">{item.detail}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
