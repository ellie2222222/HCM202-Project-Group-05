  ...
  return (
    <div className="w-full">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
        {maps.map((map, index) => (
          ...
          >
            ...
            <div className="p-4">
              <h4 className="text-[#D32F2F] font-semibold mb-3">
                Lực lượng chính:
              </h4>
              <div className="space-y-2">
                {map.forces.map((force, forceIndex) => {
                  const IconComponent =
                    forceIcons[force as keyof typeof forceIcons] || Users;
                  return (
                    <div
                      key={forceIndex}
          ...
          <div className="relative max-w-6xl max-h-full">
            ...
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/80 to-transparent p-6 rounded-b-lg">
              <h3 className="text-white font-bold text-2xl mb-2">
                {maps[selectedMap - 1].title}
              </h3>
              <p className="text-white/90 text-lg mb-4">
                {maps[selectedMap - 1].description}
              </p>
      ...
      <motion.div
        ...
        className="bg-gradient-to-r from-[#D32F2F] to-[#D67600] rounded-xl p-8 text-white text-center"
      >
