        ...
        >
          <div className="bg-gradient-to-br from-[#D32F2F] to-[#B71C1C] text-white p-10 rounded-lg">
            ...
            <p className="text-xl italic leading-relaxed">
              &ldquo;Dễ trăm lần không dân cũng chịu
              <br />
          ...
          {[
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="opacity-90 text-lg leading-relaxed mb-3">
                  {item.desc}
                </p>
              ...
              <div className="text-center">
                ...
                <button
                  onClick={() => {
                    ...
                    alert(
                      "Cảm ơn bạn đã tham gia đánh giá! Hãy chia sẻ kết quả với đồng nghiệp."
                    );
                  }}
