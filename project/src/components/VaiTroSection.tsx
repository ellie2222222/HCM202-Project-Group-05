        ...
        >
          <div className="bg-gradient-to-r from-[#D32F2F] to-[#B71C1C] text-white p-8 rounded-xl max-w-4xl mx-auto">
            <p className="text-lg md:text-xl italic leading-relaxed mb-4">
              &ldquo;Trong tư tưởng Hồ Chí Minh, đại đoàn kết toàn dân tộc không phải là sách lược hay thủ đoạn chính trị mà là chiến lược lâu dài, nhất quán của cách mạng Việt Nam.&rdquo;
            </p>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div>
                  ...
                  <p className="text-lg text-gray-700 leading-relaxed">
                    Từ thực tiễn xây dựng khối đại đoàn kết toàn dân tộc, Hồ Chí Minh đã khái quát thành nhiều luận điểm mang tính chân lý về vai trò và sức mạnh của khối đại đoàn kết toàn dân tộc: &ldquo;Đoàn kết là sức mạnh của chúng ta&rdquo;, &ldquo;Đoàn kết là một lực lượng vô địch của chúng ta để khắc phục khó khăn, giành lấy thắng lợi&rdquo;, &ldquo;Đoàn kết là sức mạnh, đoàn kết là thắng lợi&rdquo;, &ldquo;Đoàn kết là sức mạnh, là then chốt của thành công&rdquo;, &ldquo;Bây giờ còn một điểm rất quan trọng, cũng là điểm mẹ. Điểm này mà thực hiện tốt thì đẻ ra con cháu đều tốt: Đó là đoàn kết&rdquo;.
                  </p>
                </div>
              </div>
            </div>
            ...
            >
              <div className="bg-gradient-to-r from-[#FFD700] to-[#FFA000] text-[#D32F2F] p-8 rounded-xl max-w-4xl mx-auto">
                <p className="text-2xl md:text-3xl font-bold italic mb-4">
                  ...
                  <span className="text-[#D32F2F]">Thành công, thành công, đại thành công&rdquo;</span>
                </p>
